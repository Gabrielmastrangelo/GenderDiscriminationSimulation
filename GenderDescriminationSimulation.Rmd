...
After the selection process, we will carefully count the number of males and females who were promoted and compute their respective proportions. Finally, we will take the difference between the male and female proportions to understand any disparities. This entire process will be repeated multiple times to strengthen the accuracy of our findings.
...
simulation <- function() {
  ...
  sampled_prop_male_promoted <- mean(sampled == 'Male')
  return(sampled_prop_male_promoted-(1-sampled_prop_male_promoted))
}
